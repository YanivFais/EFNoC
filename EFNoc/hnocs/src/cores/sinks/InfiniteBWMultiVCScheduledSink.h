...
#ifndef ___INF_BW_MULTI_VC_SCHED_SINK_H_
#define ___INF_BW_MULTI_VC_SCHED_SINK_H_
...
//
// The InfiniteBWMultiVCScheduledSink is consuming FLITs
//
class InfiniteBWMultiVCScheduledSink: public cSimpleModule {
private:
	int numVCs;
	simtime_t statStartTime; // in sec
	int numRecPkt; // number of received packets, assume that only single source is transmitting
	// statistics
