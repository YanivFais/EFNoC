...
class NoCFlitMsg : public ::cPacket
{
  ...
  public:
    ...
    virtual void setSL(int SL_var);
    virtual int getPktId() const;
    virtual void setPktId(int pktId_var);
    virtual int getFlits() const;
    virtual void setFlits(int flits_var);
    virtual int getFlitIdx() const;
    virtual void setFlitIdx(int flitIdx_var);
    ...
    virtual void setFirstNet(bool firstNet_var);
    virtual simtime_t getInjectTime() const;
    virtual void setInjectTime(simtime_t InjectTime_var);
    virtual simtime_t getFirstNetTime() const;
    virtual void setFirstNetTime(simtime_t FirstNetTime_var);
};
...
class NoCCreditMsg : public ::cMessage
{
  ...
  public:
    ...
    virtual void setMsgs(int msgs_var);
};
...
class NoCReqMsg : public ::cMessage
{
  ...
  public:
    ...
    virtual void setOutVC(int outVC_var);
    virtual int getInVC() const;
    virtual void setInVC(int inVC_var);
    virtual int getOutPortNum() const;
    virtual void setOutPortNum(int outPortNum_var);
    virtual int getPktId() const;
    virtual void setPktId(int pktId_var);
    virtual int getNumFlits() const;
    virtual void setNumFlits(int numFlits_var);
    virtual int getNumGranted() const;
    virtual void setNumGranted(int numGranted_var);
    virtual int getNumAcked() const;
    virtual void setNumAcked(int numAcked_var);
};
...
class NoCAckMsg : public ::cMessage
{
  ...
  public:
    ...
    virtual void setOK(bool OK_var);
    virtual int getOutVC() const;
    virtual void setOutVC(int outVC_var);
    virtual int getInVC() const;
    virtual void setInVC(int inVC_var);
